...
impl<U: BitsPrimitive> PartialEq<BitString<U>> for [BitValue] {
    #[inline]
    fn eq(&self, other: &BitString<U>) -> bool {
        other.as_ref() == self
    }
...
mod tests {
    ...
    #[test]
    fn eq() {
        let bit_string_1 = "01".parse::<BitString>().unwrap();
        let bit_string_2 = "01".parse::<BitString>().unwrap();
        let bit_string_3 = "01".parse::<BitString<u8>>().unwrap();
        let bit_string_ne = "10".parse::<BitString>().unwrap();
        ...
        assert!(bit_string_1 == bit_string_1.as_ref());
        assert!(bit_string_1 == bit_string_2.as_ref());
        assert!(bit_string_1 == bit_string_3.as_ref());
        assert!(bit_string_1 != bit_string_ne.as_ref());

        assert!(bit_string_1.as_ref() == bit_string_1);
        assert!(bit_string_1.as_ref() == bit_string_2);
        assert!(bit_string_1.as_ref() == bit_string_3);
        assert!(bit_string_1.as_ref() != bit_string_ne);
